		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#onewaytwoway-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"onewaytwoway-display": {
								"semanticObject": "onewaytwoway",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=onewaytwoway",
									"url": sap.ui.require.toUrl("onewaytwoway")
								}
							}
						}
					}
