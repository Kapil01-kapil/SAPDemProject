...
//     "sap/m/ComboBox",
//     "sap/m/MultiComboBox"  // Correct import for MultiComboBox
// ], function (Filter, SmartFilterBar, MultiComboBox, FilterOperator, ) {
//     "use strict";
//     return {
...
//                         var arraysVlue = []
//                         for (let index = 0; index < vCategory.length; index++) {
//                             arraysVlue.push(new Filter("Status", "EQ", vCategory[index]));
                            
//                         }
//                         oBindingParams.filters.push(new Filter(arraysVlue, false));
//                     }

//                     // if (vCategory !== "") {
//                     //     oBindingParams.filters.push(new Filter("Status", "EQ", vCategory));
//                     // }
//                     // switch (vCategory) {
//                     //     // case "0" :
...
sap.ui.define([
    ...
    "sap/ui/comp/smartfilterbar/SmartFilterBar",
    "sap/m/MultiComboBox",              // Import MultiComboBox
    "sap/m/MessageToast"
], function (Filter, FilterOperator, SmartFilterBar, MultiComboBox, MessageToast) {
    "use strict";
    ...
    return {
        ...
        restoreCustomAppStateDataExtension: function (oCustomData) {
            // Restore the content of the MultiComboBox from the app state.
        ...
        BtnSendNoticeToEmp: function(oEvent) {
        MessageToast.show("Custom handlerrdtrg invoked.");
        },
        BtnSendNoticeToEmp: function (oEvent) {
