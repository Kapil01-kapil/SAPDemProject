		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#uploadcodedatauploaddownloadactualdata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uploadcodedatauploaddownloadactualdata-display": {
								"semanticObject": "uploadcodedatauploaddownloadactualdata",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uploadcodedata.uploaddownloadactualdata",
									"url": sap.ui.require.toUrl("uploadcodedata/uploaddownloadactualdata")
								}
							}
						}
					}
